"""
Django settings for classroom response project.
...
# Email for forgot password configuration

EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'classroomforgotemail@gmail.com'
SERVER_EMAIL = 'classroomforgotemail@gmail.com'
